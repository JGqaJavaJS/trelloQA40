...
public class BoardsHelper extends BaseHelper{
    ...
    By openMenuOneBoardPage =
            By.xpath("//button[@aria-label='Show menu']//span[@data-testid='OverflowMenuHorizontalIcon']");
    ...
    By allBoardNamesText =
            By.xpath("//h3[@class='boards-page-section-header-name']/..//div[@class='board-tile-details-name']//div");
